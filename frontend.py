...
with open('stress_prediction_app.py', 'w') as f:
    f.write('''
...
print("Streamlit app updated to use the pre-trained model 'naive_bayes_model.pkl'")
print("To run the app, use the command: streamlit run stress_prediction_app.py")